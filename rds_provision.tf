...
module "vpc" {
  source = "git@github.com:Abhiknoldur/aws-terraform-vpc_basenetwork?ref=v0.12.1"

  name = "Test1VPC"
}

module "rds_mssql" {
  source = "git@github.com:Abhiknoldur/aws-terraform-rds?ref=v0.12.8"
